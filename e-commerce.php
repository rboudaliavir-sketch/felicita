...
<head>
    ...
    <title>E-commerce Solutions - BOUDALIA Agency</title>
    <link rel="icon" type="image/png" href="logo.ico">
    <meta name="description" content="E-commerce solutions from BOUDALIA Agency. Develop and optimize your online store with our expert e-commerce development and digital marketing services.">
...
<body class="bg-white text-dark overflow-x-hidden">
            ...
            <div class="flex justify-between items-center">
                ...
                <nav class="hidden md:flex items-center space-x-8" data-aos="fade-down" data-aos-duration="800" data-aos-delay="200">
                    ...
                    <div class="border-l-2 pl-4 flex space-x-2 text-sm font-bold text-gray-400">
                        <a href="e-commerce.php" class="text-primary">EN</a>
                        <span>|</span>
                        <a href="e-commerce_fr.php" class="hover:text-gray-800 transition">FR</a>
                    </div>
                </nav>
            </div>
        </div>
    ...
    <section class="py-20 md:py-28 relative overflow-hidden bg-white z-10 border-b border-gray-100">
        ...
        <div class="container mx-auto px-4 max-w-4xl text-center relative z-10">
            <h1 class="text-5xl md:text-7xl font-extrabold mb-6 text-dark" data-aos="zoom-out-up" data-aos-duration="1000">
                E-commerce <span class="text-primary inline-block animate-pulse">Excellence</span>
            </h1>
            <p class="text-gray-600 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto mb-10" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                We launch your store in the digital world. From crafting a unique brand identity to building high-converting landing pages and scalable online stores, we are your growth partners.
            </p>
            <div data-aos="fade-up" data-aos-delay="500">
                <a href="#features" class="inline-block border-2 border-primary text-primary font-bold py-3 px-8 rounded-full hover:bg-primary hover:text-white transition duration-300 hover:-translate-y-2 shadow-sm hover:shadow-lg animate-bounce">
                    Start Selling Online <i class="fas fa-arrow-down ml-2"></i>
                </a>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="flex flex-col lg:flex-row items-center gap-16">
                <div class="lg:w-1/2 relative group" data-aos="fade-right" data-aos-duration="1200">
                    ...
                    <img src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=800&q=80" alt="E-commerce shopping interface" class="relative rounded-[2rem] shadow-2xl w-full object-cover h-[500px] transform transition duration-700 group-hover:scale-[1.02]" loading="lazy">
                </div>
                
                <div class="lg:w-1/2" data-aos="fade-left" data-aos-duration="1200">
                    <h4 class="text-sm font-bold text-gray-800 mb-4 border-b-2 border-primary pb-2 inline-block uppercase tracking-wider">Branding – Conversion – Growth</h4>
                    <h2 class="text-4xl md:text-5xl font-extrabold mb-10 text-dark leading-tight">Mastering the <span class="text-primary">Digital Market</span></h2>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-5 group hover:translate-x-2 transition-transform duration-300 bg-white p-4 rounded-2xl shadow-sm border border-transparent hover:border-orange-100" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div>
                                <h3 class="text-xl font-bold mb-2 text-dark">High-Converting Landing Pages</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">We design persuasive, fast-loading landing pages focused on a single goal: turning your visitors into buyers.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-5 group hover:translate-x-2 transition-transform duration-300 bg-white p-4 rounded-2xl shadow-sm border border-transparent hover:border-orange-100" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div>
                                <h3 class="text-xl font-bold mb-2 text-dark">Complete Branding Services</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">Stand out from the competition. We craft memorable brand identities, logos, and visual guidelines that build trust.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-5 group hover:translate-x-2 transition-transform duration-300 bg-white p-4 rounded-2xl shadow-sm border border-transparent hover:border-orange-100" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div>
                                <h3 class="text-xl font-bold mb-2 text-dark">Store Setup & Launch</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">Seamlessly launch your store on platforms like Shopify or WooCommerce, fully optimized for global sales.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-24 bg-white fade-edges overflow-hidden relative z-10">
        <div class="container mx-auto px-4 text-center mb-16" data-aos="zoom-in">
            <h4 class="text-sm font-bold uppercase tracking-wider text-primary mb-2">Platforms & Tools</h4>
            <h2 class="text-4xl md:text-5xl font-extrabold text-dark">Our E-commerce <span class="text-primary">Ecosystem</span></h2>
        </div>
            ...
            <div class="flex items-center" data-aos="fade-left" data-aos-delay="100">
                <div class="w-48 md:w-64 shrink-0 z-20 bg-white pl-4 md:pl-10">
                    <div class="inline-flex items-center gap-3 bg-light px-5 py-3 rounded-2xl shadow-sm border border-gray-200 border-l-4 border-l-primary hover:scale-105 transition-transform">
                        ...
                        <h3 class="font-extrabold text-dark uppercase tracking-wider text-sm hidden md:block">Platforms</h3>
                        <h3 class="font-extrabold text-dark uppercase tracking-wider text-xs md:hidden">Store</h3>
                    </div>
                </div>
    ...
    <section class="py-24 bg-peach relative z-10 overflow-hidden border-t border-gray-200">
        ...
        <div class="container mx-auto px-4 max-w-7xl relative z-10">
            <div class="text-center mb-20" data-aos="fade-down">
                <h2 class="text-4xl md:text-5xl font-extrabold text-dark leading-tight mb-4">Our E-Commerce<br><span class="text-primary">Workflow</span></h2>
                <p class="text-gray-600 leading-relaxed max-w-2xl mx-auto">
                    A proven roadmap to take your brand from a concept to a high-selling digital store.
                </p>
            </div>
            ...
            <div class="relative w-full max-w-5xl mx-auto">
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group">
                    ...
                    <div class="w-full pl-20 md:pl-0 md:w-5/12 md:pr-12" data-aos="fade-right" data-aos-delay="100">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-l-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Branding & Strategy</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">We establish your visual identity, target audience, and positioning to make sure your store stands out instantly.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group md:flex-row-reverse">
                    ...
                    <div class="w-full pl-20 md:pl-12 md:w-5/12" data-aos="fade-left" data-aos-delay="200">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-r-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Landing Page Design</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Designing high-converting landing pages specifically structured to highlight your star products and drive immediate sales.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group">
                    ...
                    <div class="w-full pl-20 md:pl-0 md:w-5/12 md:pr-12" data-aos="fade-right" data-aos-delay="300">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-l-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Store Development</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Configuring Shopify or WooCommerce, integrating secure payment gateways, and adding all necessary e-commerce functionalities.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full group md:flex-row-reverse" id="deployment-node">
                    ...
                    <div class="w-full pl-20 md:pl-12 md:w-5/12" data-aos="fade-left" data-aos-delay="400">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-r-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Digital Launch</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">We take your brand live to the world, ensuring fast load times, flawless mobile responsiveness, and tracking integrations.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="bg-gradient-to-r from-gray-900 to-primary rounded-[3rem] flex flex-col md:flex-row items-center overflow-hidden shadow-2xl relative" data-aos="zoom-in" data-aos-duration="1000">
                ...
                <div class="md:w-1/2 h-full z-10 overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1556740738-b6a63e27c4df?auto=format&fit=crop&w=800&q=80" alt="Card payment" class="w-full h-full object-cover min-h-[400px] transition-transform duration-1000 hover:scale-110 opacity-90 mix-blend-overlay">
                </div>
                <div class="md:w-1/2 p-10 md:p-16 text-white relative z-20">
                    <h2 class="text-4xl md:text-5xl font-extrabold mb-6 leading-tight">Ready to skyrocket your online sales?</h2>
                    <p class="text-gray-200 mb-10 text-lg leading-relaxed">
                        Let us handle the tech, the branding, and the conversions, so you can focus on fulfilling your orders and growing your business.
                    </p>
                    <a href="booking.php" class="inline-block bg-white text-primary font-bold py-4 px-10 rounded-full hover:bg-dark hover:text-white transition duration-500 shadow-lg transform hover:-translate-y-2 hover:shadow-2xl animate-pulse-glow">
                        Book a Free Strategy Call <i class="fas fa-arrow-right ml-2"></i>
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-col md:flex-row justify-between gap-10 mb-16">
                ...
                <div class="md:w-3/12 flex md:justify-center">
                    <ul class="space-y-3 font-bold text-gray-800 text-sm">
                        ...
                        <li><a href="e-commerce.php" class="text-primary transition hover:translate-x-2 inline-block transform">E-commerce Solutions</a></li>
