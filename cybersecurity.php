...
<head>
    ...
    <title>Cybersecurity Solutions - BOUDALIA Agency</title>
    <link rel="icon" type="image/png" href="logo.ico">
    <meta name="description" content="Expert cybersecurity services by BOUDALIA Agency. Penetration testing, SIEM solutions, SOAR platform, and incident response to protect your business.">
...
<body class="bg-white text-dark overflow-x-hidden">
            ...
            <div class="flex justify-between items-center">
                ...
                <nav class="hidden md:flex items-center space-x-8" data-aos="fade-down" data-aos-duration="800" data-aos-delay="200">
                    ...
                    <div class="border-l-2 pl-4 flex space-x-2 text-sm font-bold text-gray-400">
                        <a href="cybersecurity.php" class="text-primary">EN</a>
                        <span>|</span>
                        <a href="cybersecurite.php" class="hover:text-gray-800 transition">FR</a>
                    </div>
                </nav>
            </div>
        </div>
    ...
    <section class="py-20 md:py-28 relative overflow-hidden bg-white z-10 border-b border-gray-100">
        ...
        <div class="container mx-auto px-4 max-w-4xl text-center relative z-10">
            <h1 class="text-5xl md:text-7xl font-extrabold mb-6 text-dark" data-aos="zoom-out-up" data-aos-duration="1000">
                <span class="text-primary inline-block animate-pulse">Cybersecurity</span> Solutions
            </h1>
            ...
            <div data-aos="fade-up" data-aos-delay="500">
                <a href="#stack" class="inline-block border-2 border-primary text-primary font-bold py-3 px-8 rounded-full hover:bg-primary hover:text-white transition duration-300 hover:-translate-y-2 shadow-sm hover:shadow-lg animate-bounce">
                    Explore our expertise <i class="fas fa-arrow-down ml-2"></i>
                </a>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="flex flex-col lg:flex-row items-center gap-16">
                <div class="lg:w-1/2 relative group" data-aos="fade-right" data-aos-duration="1200">
                    ...
                    <img src="https://images.unsplash.com/photo-1550439062-7eb989d8a8ff?auto=format&fit=crop&w=800&q=80" alt="Cybersecurity professional working" class="relative rounded-[2rem] shadow-2xl w-full object-cover h-[500px] transform transition duration-700 group-hover:scale-[1.02]" loading="lazy">
                </div>

                <div class="lg:w-1/2" data-aos="fade-left" data-aos-duration="1200">
                    <h4 class="text-sm font-bold text-gray-800 mb-4 border-b-2 border-primary pb-2 inline-block uppercase tracking-wider">Protected – Monitored – Resilient</h4>
                    <h2 class="text-4xl md:text-5xl font-extrabold mb-10 text-dark leading-tight">Defend Your Business with <span class="text-primary">Advanced Security</span></h2>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-5 group hover:translate-x-2 transition-transform duration-300 bg-white p-4 rounded-2xl shadow-sm border border-transparent hover:border-orange-100" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div>
                                <h3 class="text-xl font-bold mb-2 text-dark">Penetration Testing</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">Comprehensive ethical hacking and vulnerability assessments to identify and fix security weaknesses before attackers do.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-5 group hover:translate-x-2 transition-transform duration-300 bg-white p-4 rounded-2xl shadow-sm border border-transparent hover:border-orange-100" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div>
                                <h3 class="text-xl font-bold mb-2 text-dark">SIEM Solutions</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">24/7 security monitoring, threat detection, and event management powered by leading SIEM platforms for continuous protection.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-5 group hover:translate-x-2 transition-transform duration-300 bg-white p-4 rounded-2xl shadow-sm border border-transparent hover:border-orange-100" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div>
                                <h3 class="text-xl font-bold mb-2 text-dark">SOAR Platform</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">Automated incident response and threat hunting to reduce detection time and enable faster remediation of security incidents.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-5 group hover:translate-x-2 transition-transform duration-300 bg-white p-4 rounded-2xl shadow-sm border border-transparent hover:border-orange-100" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div>
                                <h3 class="text-xl font-bold mb-2 text-dark">Incident Response</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">Expert breach response, forensic analysis, and recovery services to minimize damage and restore normal operations quickly.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="stack" class="py-24 bg-white fade-edges overflow-hidden relative z-10">
        <div class="container mx-auto px-4 text-center mb-16" data-aos="zoom-in">
            <h4 class="text-sm font-bold uppercase tracking-wider text-primary mb-2">Security Tools & Platforms</h4>
            <h2 class="text-4xl md:text-5xl font-extrabold text-dark">Industry-Leading <span class="text-primary">Solutions</span></h2>
            <p class="text-gray-600 mt-4 max-w-2xl mx-auto text-lg">We deploy the most trusted and cutting-edge security tools and platforms to safeguard your organization.</p>
        </div>
            ...
            <div class="flex items-center" data-aos="fade-left" data-aos-delay="100">
                <div class="w-48 md:w-64 shrink-0 z-20 bg-white pl-4 md:pl-10">
                    <div class="inline-flex items-center gap-3 bg-light px-5 py-3 rounded-2xl shadow-sm border border-gray-200 border-l-4 border-l-primary hover:scale-105 transition-transform">
                        ...
                        <h3 class="font-extrabold text-dark uppercase tracking-wider text-sm hidden md:block">Penetration</h3>
                        <h3 class="font-extrabold text-dark uppercase tracking-wider text-xs md:hidden">Penet</h3>
                    </div>
                </div>
                <div class="marquee-container animate-scroll-left">
                    <div class="flex items-center">
                        ...
                        <div class="tech-card"><i class="fas fa-shield-alt text-primary"></i><span class="font-bold">OWASP Tools</span></div>
            ...
            <div class="flex items-center" data-aos="fade-right" data-aos-delay="200">
                <div class="w-48 md:w-64 shrink-0 z-20 bg-white pl-4 md:pl-10">
                    <div class="inline-flex items-center gap-3 bg-light px-5 py-3 rounded-2xl shadow-sm border border-gray-200 border-l-4 border-l-primary hover:scale-105 transition-transform">
                        ...
                        <h3 class="font-extrabold text-dark uppercase tracking-wider text-sm hidden md:block">SIEM & Monitor</h3>
            ...
            <div class="flex items-center" data-aos="fade-left" data-aos-delay="300">
                <div class="w-48 md:w-64 shrink-0 z-20 bg-white pl-4 md:pl-10">
                    <div class="inline-flex items-center gap-3 bg-light px-5 py-3 rounded-2xl shadow-sm border border-gray-200 border-l-4 border-l-primary hover:scale-105 transition-transform">
                        ...
                        <h3 class="font-extrabold text-dark uppercase tracking-wider text-sm hidden md:block">SOAR & Response</h3>
    ...
    <section class="py-24 bg-peach relative z-10 overflow-hidden border-t border-gray-200">
        ...
        <div class="container mx-auto px-4 max-w-7xl relative z-10">
            <div class="text-center mb-20" data-aos="fade-down">
                <h2 class="text-4xl md:text-5xl font-extrabold text-dark leading-tight mb-4">Security<br><span class="text-primary">Engagement Process</span></h2>
            ...
            <div class="relative w-full max-w-5xl mx-auto">
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group">
                    ...
                    <div class="w-full pl-20 md:pl-0 md:w-5/12 md:pr-12" data-aos="fade-right" data-aos-delay="100">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-l-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Assessment & Discovery</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Comprehensive evaluation of your security infrastructure, policies, practices, and potential vulnerabilities.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group md:flex-row-reverse">
                    ...
                    <div class="w-full pl-20 md:pl-12 md:w-5/12" data-aos="fade-left" data-aos-delay="200">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-r-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Vulnerability Analysis</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">In-depth analysis using automated and manual techniques to identify security weaknesses and misconfigurations.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group">
                    ...
                    <div class="w-full pl-20 md:pl-0 md:w-5/12 md:pr-12" data-aos="fade-right" data-aos-delay="300">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-l-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Exploitation & Testing</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Controlled exploitation of vulnerabilities to assess real-world impact and validate security controls.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group md:flex-row-reverse">
                    ...
                    <div class="w-full pl-20 md:pl-12 md:w-5/12" data-aos="fade-left" data-aos-delay="400">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-r-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Detailed Reporting</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Comprehensive documentation with risk ratings, proof-of-concept demonstrations, and executive summaries.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group">
                    ...
                    <div class="w-full pl-20 md:pl-0 md:w-5/12 md:pr-12" data-aos="fade-right" data-aos-delay="500">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-l-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Remediation Planning</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Collaborative development of remediation strategies, prioritization guidance, and implementation support.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full group md:flex-row-reverse" id="deployment-node">
                    ...
                    <div class="w-full pl-20 md:pl-12 md:w-5/12" data-aos="fade-left" data-aos-delay="600">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-r-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Compliance & Verification</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Validation testing, compliance assessment, and continuous monitoring to ensure security improvements are effective.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="bg-gradient-to-r from-gray-900 to-primary rounded-[3rem] flex flex-col md:flex-row items-center overflow-hidden shadow-2xl relative" data-aos="zoom-in" data-aos-duration="1000">
                ...
                <div class="md:w-1/2 h-full z-10 overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&w=800&q=80" alt="Security monitoring" class="w-full h-full object-cover min-h-[400px] transition-transform duration-1000 hover:scale-110 opacity-90 mix-blend-overlay">
                </div>
                <div class="md:w-1/2 p-10 md:p-16 text-white relative z-20">
                    <h2 class="text-4xl md:text-5xl font-extrabold mb-6 leading-tight">Proactive threat management aligned with your defense goals</h2>
                    ...
                    <a href="booking.php" class="inline-block bg-white text-primary font-bold py-4 px-10 rounded-full hover:bg-dark hover:text-white transition duration-500 shadow-lg transform hover:-translate-y-2 hover:shadow-2xl animate-pulse-glow">
                        Schedule a Security Consultation <i class="fas fa-arrow-right ml-2"></i>
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-col md:flex-row justify-between gap-10 mb-16">
                <div class="md:w-5/12">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed pr-4">
                        BOUDALIA Agency is your trusted partner for comprehensive cybersecurity and digital solutions. From protecting your infrastructure to transforming your digital presence, we deliver results you can trust.
                    </p>
                </div>
                <div class="md:w-3/12 flex md:justify-center">
                    <ul class="space-y-3 font-bold text-gray-800 text-sm">
                        ...
                        <li><a href="cybersecurity.php" class="text-primary transition hover:translate-x-2 inline-block transform">Cybersecurity</a></li>
                    </ul>
                </div>
