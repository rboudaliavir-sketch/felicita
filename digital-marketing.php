...
<head>
    ...
    <title>Digital Marketing - BOUDALIA Agency</title>
    <link rel="icon" type="image/png" href="logo.ico">
    <meta name="description" content="Comprehensive digital marketing services by BOUDALIA Agency. Boost your online presence with SEO, PPC, content marketing, and social media strategies.">
...
<body class="bg-white text-dark overflow-x-hidden">
            ...
            <div class="flex justify-between items-center">
                ...
                <nav class="hidden md:flex items-center space-x-8" data-aos="fade-down" data-aos-duration="800" data-aos-delay="200">
                    ...
                    <div class="border-l-2 pl-4 flex space-x-2 text-sm font-bold text-gray-400">
                        <a href="digital-marketing.php" class="text-primary">EN</a>
                        <span>|</span>
                        <a href="digital-marketing_fr.php" class="hover:text-gray-800 transition">FR</a>
                    </div>
                </nav>
            </div>
        </div>
    ...
    <section class="py-24 md:py-32 relative overflow-hidden bg-dark z-10">
        ...
        <div class="container mx-auto px-4 max-w-4xl text-center relative z-10 text-white">
            <h1 class="text-5xl md:text-7xl font-extrabold mb-6 leading-tight" data-aos="zoom-out-up" data-aos-duration="1000">
                Digital <span class="text-primary inline-block animate-pulse">Marketing</span>
            </h1>
            <p class="text-gray-300 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto mb-10" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                Unlock your potential with BOUDALIA Agency: Elevate your brand through innovative digital marketing strategies. From captivating content creation to strategic social media campaigns, we drive engagement and boost your online presence.
            </p>
            <div data-aos="fade-up" data-aos-delay="500">
                <a href="#process" class="inline-block border-2 border-primary text-primary font-bold py-3 px-8 rounded-full hover:bg-primary hover:text-white transition duration-300 hover:-translate-y-2 animate-bounce">
                    Our Methodology <i class="fas fa-arrow-down ml-2"></i>
                </a>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="flex flex-col lg:flex-row items-center gap-16">
                <div class="lg:w-1/2 relative group" data-aos="fade-right" data-aos-duration="1200">
                    ...
                    <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80" alt="Marketing Data Analytics" class="relative rounded-[2rem] shadow-2xl w-full object-cover h-[500px] transform transition duration-700 group-hover:scale-[1.02]" loading="lazy">
                ...
                <div class="lg:w-1/2" data-aos="fade-left" data-aos-duration="1200">
                    ...
                    <h2 class="text-4xl md:text-5xl font-extrabold mb-10 text-dark leading-tight">Drive Your Business Success with <span class="text-primary">Digital Marketing</span></h2>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-5 group hover:translate-x-2 transition-transform duration-300 bg-white p-4 rounded-2xl shadow-sm border border-transparent hover:border-orange-100 hover:bg-orange-50" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div>
                                <h3 class="text-xl font-bold mb-2 text-dark">Enhanced Brand Experience</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">Targeted communication and well-crafted content ensure a strong and memorable brand image.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-5 group hover:translate-x-2 transition-transform duration-300 bg-white p-4 rounded-2xl shadow-sm border border-transparent hover:border-orange-100 hover:bg-orange-50" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed">Contribute to your company's growth and profitability by turning audiences into loyal customers.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-5 group hover:translate-x-2 transition-transform duration-300 bg-white p-4 rounded-2xl shadow-sm border border-transparent hover:border-orange-100 hover:bg-orange-50" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div>
                                <h3 class="text-xl font-bold mb-2 text-dark">Competitive Advantage</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">Our data-driven strategies ensure sustainable success and make you stand out in a crowded market.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-4 max-w-7xl relative z-10">
            <div class="text-center mb-20" data-aos="fade-down">
                ...
                <p class="text-gray-600 leading-relaxed max-w-2xl mx-auto">
                    Elevate your brand with BOUDALIA Agency's digital marketing expertise. Our team of experts develops strategic plans tailored to your business, ensuring a targeted and impactful online presence.
                </p>
            </div>
            ...
            <div class="relative w-full max-w-5xl mx-auto">
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group">
                    ...
                    <div class="w-full pl-20 md:pl-0 md:w-5/12 md:pr-12" data-aos="fade-right" data-aos-delay="100">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-l-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Custom Planning</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Once the analysis data is gathered, we design a customized digital marketing plan. This plan includes a mix of SEO optimization, social media strategies, content marketing, and more.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group md:flex-row-reverse">
                    ...
                    <div class="w-full pl-20 md:pl-12 md:w-5/12" data-aos="fade-left" data-aos-delay="200">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-r-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Data-Driven Analytics</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">In the digital world, data is king. Using advanced analytics tools, we monitor user behavior, campaign effectiveness, and adjust our strategies in real time.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group">
                    ...
                    <div class="w-full pl-20 md:pl-0 md:w-5/12 md:pr-12" data-aos="fade-right" data-aos-delay="300">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-l-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Continuous Optimization</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Digital landscapes are dynamic, and we adapt to changes. BOUDALIA Agency is committed to continuously optimizing your campaigns: adjusting keywords or refining social strategies.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full group md:flex-row-reverse" id="deployment-node">
                    ...
                    <div class="w-full pl-20 md:pl-12 md:w-5/12" data-aos="fade-left" data-aos-delay="400">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-r-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Ongoing Support</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Our commitment doesn't end with implementation. We provide ongoing support to answer your questions, make adjustments, and explore new growth opportunities.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="bg-gradient-to-r from-gray-900 to-primary rounded-[3rem] flex flex-col md:flex-row items-center overflow-hidden shadow-2xl relative" data-aos="zoom-in" data-aos-duration="1000">
                ...
                <div class="md:w-1/2 h-full z-10 overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1556761175-4b46a572b786?auto=format&fit=crop&w=800&q=80" alt="Marketing Strategy Team" class="w-full h-full object-cover min-h-[400px] transition-transform duration-1000 hover:scale-110 opacity-90 mix-blend-overlay">
                </div>
                <div class="md:w-1/2 p-10 md:p-16 text-white relative z-20">
                    ...
                    <p class="text-gray-200 mb-10 text-lg leading-relaxed">
                        At BOUDALIA Agency, we offer a range of innovative and cutting-edge solutions for your business needs. From web development to digital marketing, we have the expertise to deliver high-quality results.
                    </p>
                    <a href="booking.php" class="inline-block bg-white text-primary font-bold py-4 px-10 rounded-full hover:bg-dark hover:text-white transition duration-500 shadow-lg transform hover:-translate-y-2 hover:shadow-2xl animate-pulse-glow">
                        Start a Project <i class="fas fa-arrow-right ml-2"></i>
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-col md:flex-row justify-between gap-10 mb-16">
                <div class="md:w-5/12">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed pr-4">
                        BOUDALIA Agency is your premier destination for all your digital needs. From creating visually stunning websites to implementing formidable acquisition strategies.
                    </p>
                </div>
                <div class="md:w-3/12 flex md:justify-center">
                    <ul class="space-y-3 font-bold text-gray-800 text-sm">
                        ...
                        <li><a href="digital-marketing.php" class="text-primary transition hover:translate-x-2 inline-block transform">Digital Marketing</a></li>
    ...
    <script>
        ...
        // FIREWORKS Animation (Confetti) on Node 4 (Ongoing Support)
