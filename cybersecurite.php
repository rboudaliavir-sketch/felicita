...
<head>
    ...
    <title>Solutions de Cybersécurité - BOUDALIA Agency</title>
    <link rel="icon" type="image/png" href="logo.ico">
    <meta name="description" content="Services de cybersécurité experts de BOUDALIA Agency. Tests de pénétration, solutions SIEM, plateforme SOAR et réponse aux incidents pour protéger votre entreprise.">
...
<body class="bg-white text-dark overflow-x-hidden">
    ...
    <div class="fixed-bg-snowflakes">
        <div class="snowflake animate-float" style="top: 15%; left: 8%;"><i class="fas fa-shield-alt text-4xl animate-spin-slow"></i></div>
        <div class="snowflake animate-float-delayed" style="top: 25%; right: 12%;"><i class="fas fa-lock text-6xl animate-spin-slow-reverse opacity-50"></i></div>
        <div class="snowflake animate-float" style="top: 65%; left: 20%;"><i class="fas fa-key text-5xl animate-spin-slow"></i></div>
        <div class="snowflake animate-float-delayed" style="top: 75%; right: 15%;"><i class="fas fa-exclamation-triangle text-4xl animate-spin-slow-reverse"></i></div>
        <div class="snowflake animate-float" style="top: 45%; left: 85%;"><i class="fas fa-virus text-7xl animate-spin-slow opacity-10"></i></div>
    </div>
            ...
            <div class="flex justify-between items-center">
                ...
                <nav class="hidden md:flex items-center space-x-8" data-aos="fade-down" data-aos-duration="800" data-aos-delay="200">
                    <ul class="flex space-x-8 font-medium">
                        <li><a href="index.php" class="hover:text-primary transition hover:-translate-y-1 inline-block transform">Accueil</a></li>
                    ...
                    <a href="booking.php" class="bg-primary text-white font-bold py-2 px-6 rounded-full hover:bg-secondary transition hover:-translate-y-1 hover:shadow-lg animate-pulse-glow" data-aos="fade-left">Réserver un appel</a>

                    <div class="border-l-2 pl-4 flex space-x-2 text-sm font-bold text-gray-400">
                        <a href="cybersecurity.php" class="hover:text-gray-800 transition">EN</a>
                        <span>|</span>
                        <a href="cybersecurite.php" class="text-primary">FR</a>
                    </div>
                </nav>
            </div>
        </div>
    ...
    <section class="py-20 md:py-28 relative overflow-hidden bg-white z-10 border-b border-gray-100">
        <i class="fas fa-lock starburst top-10 left-32 animate-spin-slow-reverse"></i>
        <i class="fas fa-shield-alt starburst bottom-10 right-32 animate-spin-slow text-orange-200"></i>
        ...
        <div class="container mx-auto px-4 max-w-4xl text-center relative z-10">
            <h1 class="text-5xl md:text-7xl font-extrabold mb-6 text-dark" data-aos="zoom-out-up" data-aos-duration="1000">
                Solutions de <span class="text-primary inline-block animate-pulse">Cybersécurité</span>
            </h1>
            ...
            <div data-aos="fade-up" data-aos-delay="500">
                <a href="#stack" class="inline-block border-2 border-primary text-primary font-bold py-3 px-8 rounded-full hover:bg-primary hover:text-white transition duration-300 hover:-translate-y-2 shadow-sm hover:shadow-lg animate-bounce">
                    Explorez nos expertises <i class="fas fa-arrow-down ml-2"></i>
                </a>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="flex flex-col lg:flex-row items-center gap-16">
                <div class="lg:w-1/2 relative group" data-aos="fade-right" data-aos-duration="1200">
                    ...
                    <img src="https://images.unsplash.com/photo-1550439062-7eb989d8a8ff?auto=format&fit=crop&w=800&q=80" alt="Professionnel en cybersécurité" class="relative rounded-[2rem] shadow-2xl w-full object-cover h-[500px] transform transition duration-700 group-hover:scale-[1.02]" loading="lazy">
                </div>

                <div class="lg:w-1/2" data-aos="fade-left" data-aos-duration="1200">
                    <h4 class="text-sm font-bold text-gray-800 mb-4 border-b-2 border-primary pb-2 inline-block uppercase tracking-wider">Protégé – Surveillé – Résilient</h4>
                    <h2 class="text-4xl md:text-5xl font-extrabold mb-10 text-dark leading-tight">Défendez Votre Entreprise avec <span class="text-primary">une Sécurité Avancée</span></h2>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-5 group hover:translate-x-2 transition-transform duration-300 bg-white p-4 rounded-2xl shadow-sm border border-transparent hover:border-orange-100" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div>
                                <h3 class="text-xl font-bold mb-2 text-dark">Tests de Pénétration</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">Tests de sécurité éthiques complets et évaluations des vulnérabilités pour identifier et corriger les faiblesses avant les attaquants.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-5 group hover:translate-x-2 transition-transform duration-300 bg-white p-4 rounded-2xl shadow-sm border border-transparent hover:border-orange-100" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div>
                                <h3 class="text-xl font-bold mb-2 text-dark">Solutions SIEM</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">Surveillance de sécurité 24/7, détection des menaces et gestion des événements alimentées par les principales plateformes SIEM.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-5 group hover:translate-x-2 transition-transform duration-300 bg-white p-4 rounded-2xl shadow-sm border border-transparent hover:border-orange-100" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div>
                                <h3 class="text-xl font-bold mb-2 text-dark">Plateforme SOAR</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">Réponse aux incidents automatisée et chasse aux menaces pour réduire les délais de détection et permettre une remédiation plus rapide.</p>
                            </div>
                        </div>

                        <div class="flex items-start gap-5 group hover:translate-x-2 transition-transform duration-300 bg-white p-4 rounded-2xl shadow-sm border border-transparent hover:border-orange-100" data-aos="fade-up" data-aos-delay="400">
                            <div class="w-14 h-14 rounded-xl bg-orange-50 flex items-center justify-center text-primary text-2xl shrink-0 group-hover:bg-primary group-hover:text-white transition-colors duration-300">
                                <i class="fas fa-redo"></i>
                            </div>
                            <div>
                                <h3 class="text-xl font-bold mb-2 text-dark">Réponse aux Incidents</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">Services experts de réponse aux violations, d'analyse médico-légale et de récupération pour minimiser les dégâts et restaurer les opérations.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="stack" class="py-24 bg-white fade-edges overflow-hidden relative z-10">
        <div class="container mx-auto px-4 text-center mb-16" data-aos="zoom-in">
            <h4 class="text-sm font-bold uppercase tracking-wider text-primary mb-2">Outils et Plateformes Sectoriels</h4>
            <h2 class="text-4xl md:text-5xl font-extrabold text-dark">Solutions de Pointe <span class="text-primary">et Fiables</span></h2>
            <p class="text-gray-600 mt-4 max-w-2xl mx-auto text-lg">Nous déployons les outils et les plateformes de sécurité les plus confiés et les plus avancés pour protéger votre organisation.</p>
        </div>
            ...
            <div class="flex items-center" data-aos="fade-left" data-aos-delay="100">
                <div class="w-48 md:w-64 shrink-0 z-20 bg-white pl-4 md:pl-10">
                    <div class="inline-flex items-center gap-3 bg-light px-5 py-3 rounded-2xl shadow-sm border border-gray-200 border-l-4 border-l-primary hover:scale-105 transition-transform">
                        ...
                        <h3 class="font-extrabold text-dark uppercase tracking-wider text-sm hidden md:block">Pénétration</h3>
                        <h3 class="font-extrabold text-dark uppercase tracking-wider text-xs md:hidden">Péné</h3>
                    </div>
                </div>
                <div class="marquee-container animate-scroll-left">
                    <div class="flex items-center">
                        <div class="tech-card"><i class="fas fa-code text-primary"></i><span class="font-bold">Burp Suite</span></div>
                        <div class="tech-card"><i class="fas fa-skull text-primary"></i><span class="font-bold">Metasploit</span></div>
                        <div class="tech-card"><i class="fas fa-terminal text-primary"></i><span class="font-bold">Kali Linux</span></div>
                        <div class="tech-card"><i class="fas fa-shield-alt text-primary"></i><span class="font-bold">OWASP</span></div>
                        <div class="tech-card"><i class="fas fa-lock text-primary"></i><span class="font-bold">Fortify</span></div>
                        <div class="tech-card"><i class="fas fa-check-circle text-primary"></i><span class="font-bold">Nessus</span></div>
                    </div>
                    <div class="flex items-center">
                        <div class="tech-card"><i class="fas fa-code text-primary"></i><span class="font-bold">Burp Suite</span></div>
                        <div class="tech-card"><i class="fas fa-skull text-primary"></i><span class="font-bold">Metasploit</span></div>
            ...
            <div class="flex items-center" data-aos="fade-right" data-aos-delay="200">
                <div class="w-48 md:w-64 shrink-0 z-20 bg-white pl-4 md:pl-10">
                    <div class="inline-flex items-center gap-3 bg-light px-5 py-3 rounded-2xl shadow-sm border border-gray-200 border-l-4 border-l-primary hover:scale-105 transition-transform">
                        ...
                        <h3 class="font-extrabold text-dark uppercase tracking-wider text-sm hidden md:block">SIEM & Monitoring</h3>
                        <h3 class="font-extrabold text-dark uppercase tracking-wider text-xs md:hidden">SIEM</h3>
                    </div>
                </div>
                <div class="marquee-container animate-scroll-right">
                    <div class="flex items-center">
                        <div class="tech-card"><i class="fas fa-chart-line text-primary"></i><span class="font-bold">Splunk</span></div>
                        <div class="tech-card"><i class="fas fa-database text-primary"></i><span class="font-bold">Elasticsearch</span></div>
                        <div class="tech-card"><i class="fas fa-layer-group text-primary"></i><span class="font-bold">Sumo Logic</span></div>
                        <div class="tech-card"><i class="fas fa-network-wired text-primary"></i><span class="font-bold">ArcSight</span></div>
                        <div class="tech-card border-orange-200 bg-orange-50 text-primary"><i class="fas fa-search text-2xl"></i><span class="font-extrabold">ELK Stack</span></div>
                        <div class="tech-card"><i class="fas fa-bell text-primary"></i><span class="font-bold">QRadar</span></div>
                    </div>
                    <div class="flex items-center">
                        <div class="tech-card"><i class="fas fa-chart-line text-primary"></i><span class="font-bold">Splunk</span></div>
                        <div class="tech-card"><i class="fas fa-database text-primary"></i><span class="font-bold">Elasticsearch</span></div>
            ...
            <div class="flex items-center" data-aos="fade-left" data-aos-delay="300">
                <div class="w-48 md:w-64 shrink-0 z-20 bg-white pl-4 md:pl-10">
                    <div class="inline-flex items-center gap-3 bg-light px-5 py-3 rounded-2xl shadow-sm border border-gray-200 border-l-4 border-l-primary hover:scale-105 transition-transform">
                        ...
                        <h3 class="font-extrabold text-dark uppercase tracking-wider text-sm hidden md:block">SOAR & Réponse</h3>
                        <h3 class="font-extrabold text-dark uppercase tracking-wider text-xs md:hidden">SOAR</h3>
                    </div>
                </div>
                <div class="marquee-container animate-scroll-left" style="animation-duration: 45s;">
                    <div class="flex items-center">
                        <div class="tech-card"><i class="fas fa-magic text-primary"></i><span class="font-bold">Demisto</span></div>
                        <div class="tech-card"><i class="fas fa-boxes text-primary"></i><span class="font-bold">Splunk SOAR</span></div>
                        <div class="tech-card"><i class="fas fa-tasks text-primary"></i><span class="font-bold">ServiceNow</span></div>
                        <div class="tech-card"><i class="fas fa-cogs text-primary"></i><span class="font-bold">Automation</span></div>
                        <div class="tech-card"><i class="fas fa-crown text-primary"></i><span class="font-bold">CrowdStrike</span></div>
                        <div class="tech-card"><i class="fas fa-fire text-primary"></i><span class="font-bold">Palo Alto</span></div>
                    </div>
                    <div class="flex items-center">
                        <div class="tech-card"><i class="fas fa-magic text-primary"></i><span class="font-bold">Demisto</span></div>
                        <div class="tech-card"><i class="fas fa-boxes text-primary"></i><span class="font-bold">Splunk SOAR</span></div>
    ...
    <section class="py-24 bg-peach relative z-10 overflow-hidden border-t border-gray-200">
        <div class="absolute right-0 top-10 text-primary opacity-5"><i class="fas fa-shield-alt text-[25rem] animate-spin-slow-reverse"></i></div>

        <div class="container mx-auto px-4 max-w-7xl relative z-10">
            <div class="text-center mb-20" data-aos="fade-down">
                <h2 class="text-4xl md:text-5xl font-extrabold text-dark leading-tight mb-4">Processus<br><span class="text-primary">d'Engagement en Sécurité</span></h2>
            ...
            <div class="relative w-full max-w-5xl mx-auto">
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group">
                    ...
                    <div class="w-full pl-20 md:pl-0 md:w-5/12 md:pr-12" data-aos="fade-right" data-aos-delay="100">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-l-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Évaluation & Découverte</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Évaluation complète de votre infrastructure de sécurité, politiques, pratiques et vulnérabilités potentielles.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group md:flex-row-reverse">
                    ...
                    <div class="w-full pl-20 md:pl-12 md:w-5/12" data-aos="fade-left" data-aos-delay="200">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-r-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Analyse des Vulnérabilités</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Analyse approfondie utilisant des techniques automatisées et manuelles pour identifier les faiblesses de sécurité et les erreurs de configuration.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group">
                    ...
                    <div class="w-full pl-20 md:pl-0 md:w-5/12 md:pr-12" data-aos="fade-right" data-aos-delay="300">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-l-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Exploitation & Tests</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Exploitation contrôlée des vulnérabilités pour évaluer l'impact réel et valider les contrôles de sécurité.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group md:flex-row-reverse">
                    ...
                    <div class="w-full pl-20 md:pl-12 md:w-5/12" data-aos="fade-left" data-aos-delay="400">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-r-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Rapports Détaillés</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Documentation complète avec classifications des risques, démonstrations de preuve de concept et résumés exécutifs.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group">
                    ...
                    <div class="w-full pl-20 md:pl-0 md:w-5/12 md:pr-12" data-aos="fade-right" data-aos-delay="500">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-l-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Plan de Remédiation</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Développement collaboratif des stratégies de remédiation, conseils de hiérarchisation et soutien à la mise en œuvre.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full group md:flex-row-reverse" id="deployment-node">
                    ...
                    <div class="w-full pl-20 md:pl-12 md:w-5/12" data-aos="fade-left" data-aos-delay="600">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-r-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Conformité & Vérification</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Tests de validation, évaluation de la conformité et surveillance continue pour assurer l'efficacité des améliorations de sécurité.</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-0 mb-20 relative z-20">
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="bg-gradient-to-r from-gray-900 to-primary rounded-[3rem] flex flex-col md:flex-row items-center overflow-hidden shadow-2xl relative" data-aos="zoom-in" data-aos-duration="1000">
                ...
                <div class="absolute top-10 right-20 text-white opacity-20 animate-float"><i class="fas fa-lock text-9xl"></i></div>

                <div class="md:w-1/2 h-full z-10 overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&w=800&q=80" alt="Surveillance de sécurité" class="w-full h-full object-cover min-h-[400px] transition-transform duration-1000 hover:scale-110 opacity-90 mix-blend-overlay">
                </div>
                <div class="md:w-1/2 p-10 md:p-16 text-white relative z-20">
                    <h2 class="text-4xl md:text-5xl font-extrabold mb-6 leading-tight">Gestion proactive des menaces alignée avec vos objectifs de défense</h2>
                    ...
                    <a href="booking.php" class="inline-block bg-white text-primary font-bold py-4 px-10 rounded-full hover:bg-dark hover:text-white transition duration-500 shadow-lg transform hover:-translate-y-2 hover:shadow-2xl animate-pulse-glow">
                        Planifier une Consultation <i class="fas fa-arrow-right ml-2"></i>
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-col md:flex-row justify-between gap-10 mb-16">
                <div class="md:w-5/12">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed pr-4">
                        BOUDALIA Agency est votre partenaire de confiance pour la cybersécurité et les solutions numériques complètes. De la protection de votre infrastructure à la transformation de votre présence numérique, nous livrons des résultats en lesquels vous pouvez avoir confiance.
                    </p>
                </div>
                <div class="md:w-3/12 flex md:justify-center">
                    <ul class="space-y-3 font-bold text-gray-800 text-sm">
                        <li><a href="index.php" class="hover:text-primary transition hover:translate-x-2 inline-block transform">Accueil</a></li>
                        <li><a href="services.php" class="hover:text-primary transition hover:translate-x-2 inline-block transform">Services</a></li>
                        <li><a href="ui-ux.php" class="hover:text-primary transition hover:translate-x-2 inline-block transform">Design UX/UI</a></li>
                        <li><a href="web-dev_fr.php" class="hover:text-primary transition hover:translate-x-2 inline-block transform">Web Development</a></li>
                        ...
                        <li><a href="cybersecurite.php" class="text-primary transition hover:translate-x-2 inline-block transform">Cybersécurité</a></li>
                    </ul>
                </div>
