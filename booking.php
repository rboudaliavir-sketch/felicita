...
<head>
    ...
    <title>Book a Call - BOUDALIA Agency</title>
    <link rel="icon" type="image/png" href="logo.ico">
    <meta name="description" content="Book a consultation call with BOUDALIA Agency. Schedule your free call with our creative digital experts today.">
        ...
        <div class="container mx-auto px-4 py-4 max-w-7xl relative z-10">
            <div class="flex justify-between items-center">
                ...
                <nav class="hidden md:flex items-center space-x-8" data-aos="fade-down" data-aos-duration="800" data-aos-delay="200">
                    ...
                    <a href="booking.php" class="bg-primary text-white font-bold py-2 px-6 rounded-full shadow-lg">Book a Call</a>
                    
                    <div class="border-l-2 pl-4 flex space-x-2 text-sm font-bold text-gray-400">
                        <a href="booking.php" class="text-primary">EN</a>
                        <span>|</span>
                        <a href="formulaire.php" class="hover:text-gray-800 transition">FR</a>
                    </div>
                </nav>
            </div>
        </div>
            ...
            <div class="flex flex-col lg:flex-row gap-16">
                ...
                <div class="lg:w-5/12" data-aos="fade-right" data-aos-duration="1000">
                    <div class="sticky top-32">
                        <h4 class="text-primary font-bold tracking-wider uppercase mb-2">Let's Talk</h4>
                        <h1 class="text-4xl md:text-6xl font-extrabold text-dark leading-tight mb-6">
                            Ready to <span class="text-primary">grow</span> your business?
                        </h1>
                        <p class="text-gray-600 text-lg mb-10 leading-relaxed">
                            Book a free discovery call with our experts. We'll discuss your goals, analyze your current digital presence, and show you how BOUDALIA Agency can help you scale.
                        </p>
                        ...
                        <div class="space-y-6">
                            <div class="flex items-center gap-4 bg-white p-4 rounded-2xl shadow-sm border border-gray-100 transition-transform hover:-translate-y-1">
                                ...
                                <div>
                                    <h3 class="font-bold text-dark">30-Minute Strategy Call</h3>
                                    <p class="text-sm text-gray-500">Free, no-obligation consultation via Google Meet or Zoom.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-4 bg-white p-4 rounded-2xl shadow-sm border border-gray-100 transition-transform hover:-translate-y-1">
                                ...
                                <div>
                                    <h3 class="font-bold text-dark">Call Us directly</h3>
                ...
                <div class="lg:w-7/12" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
                    <div class="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-2xl relative overflow-hidden">
                        ...
                        <h2 class="text-2xl font-bold text-dark mb-8">Fill out the form below</h2>
                        
                        <form action="#" method="POST" class="space-y-6 relative z-10">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2" for="firstName">First Name <span class="text-red-500">*</span></label>
                                    <input type="text" id="firstName" name="firstName" required class="form-input" placeholder="John">
                                </div>
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2" for="lastName">Last Name <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2" for="service">What are you interested in? <span class="text-red-500">*</span></label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2" for="date">Preferred Date</label>
                                    <input type="date" id="date" name="date" class="form-input text-gray-600">
                                </div>
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2" for="time">Preferred Time</label>
                            ...
                            <div>
                                ...
                                <textarea id="message" name="message" rows="4" class="form-input resize-none" placeholder="Describe your goals, current challenges, or any specific requirements..."></textarea>
                            </div>

                            <button type="submit" class="w-full bg-primary text-white font-bold py-4 px-8 rounded-xl hover:bg-secondary transition duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 animate-pulse-glow flex justify-center items-center">
                                <span>Request a Meeting</span>
                                <i class="fas fa-paper-plane ml-3"></i>
                            </button>
                            
                            <p class="text-xs text-gray-400 text-center mt-4">
                                By submitting this form, you agree to our <a href="privacy-policy.php" class="underline hover:text-primary">Privacy Policy</a>.
                            </p>
                        </form>
                    </div>
                </div>
            ...
            <div class="flex flex-col md:flex-row justify-between gap-10 mb-16">
                <div class="md:w-5/12">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed pr-4">
                        BOUDALIA Agency is your premier destination for all your digital needs. From creating visually stunning websites to implementing formidable digital strategies.
                    </p>
                </div>
