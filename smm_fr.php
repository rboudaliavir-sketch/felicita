...
<head>
    ...
    <title>Social Media Marketing - BOUDALIA Agency</title>
    <link rel="icon" type="image/png" href="logo.ico">
    <meta name="description" content="Services de marketing réseaux sociaux par BOUDALIA Agency. Augmentez votre présence sur les réseaux sociaux et engagez votre audience.">
    ...
    <style>
        ...
        /* Animations Stack Technique Ads */
        ...
        .social-card {
            display: flex; align-items: center; gap: 12px; background: white; padding: 12px 28px;
            border-radius: 99px; box-shadow: 0 4px 10px -1px rgba(0, 0, 0, 0.08); border: 2px solid transparent;
            margin: 0 12px; transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275); cursor: default;
        }
        .social-card:hover { transform: translateY(-8px) scale(1.05); z-index: 20; box-shadow: 0 15px 20px -3px rgba(0,0,0,0.1);}

        /* Couleurs de bordures au hover pour les réseaux */
        .hover-tiktok:hover { border-color: #000000; box-shadow: 0 15px 20px -3px rgba(0,0,0,0.2);}
        .hover-snapchat:hover { border-color: #FFFC00; box-shadow: 0 15px 20px -3px rgba(255,252,0,0.4);}
        .hover-meta:hover { border-color: #0668E1; box-shadow: 0 15px 20px -3px rgba(6,104,225,0.3);}
        .hover-insta:hover { border-color: #E1306C; box-shadow: 0 15px 20px -3px rgba(225,48,108,0.3);}
        .hover-linkedin:hover { border-color: #0077b5; box-shadow: 0 15px 20px -3px rgba(0,119,181,0.3);}
        .hover-pinterest:hover { border-color: #E60023; box-shadow: 0 15px 20px -3px rgba(230,0,35,0.3);}
        .hover-x:hover { border-color: #14171A; box-shadow: 0 15px 20px -3px rgba(20,23,26,0.3);}
        .hover-youtube:hover { border-color: #FF0000; box-shadow: 0 15px 20px -3px rgba(255,0,0,0.3);}

        /* Effets Workflow / Process */
        ...
        /* Arrière-plan animé Snowflakes/Formes SMM */
        .fixed-bg-snowflakes {
...
<body class="bg-white text-dark overflow-x-hidden">
    ...
    <div class="fixed-bg-snowflakes">
        <div class="snowflake animate-float" style="top: 15%; left: 8%;"><i class="fas fa-heart text-4xl animate-spin-slow text-pink-500 opacity-20"></i></div>
        <div class="snowflake animate-float-delayed" style="top: 25%; right: 12%;"><i class="fas fa-share-nodes text-6xl animate-spin-slow-reverse opacity-40"></i></div>
        <div class="snowflake animate-float" style="top: 65%; left: 20%;"><i class="fas fa-thumbs-up text-5xl animate-spin-slow text-blue-500 opacity-20"></i></div>
        <div class="snowflake animate-float-delayed" style="top: 75%; right: 15%;"><i class="fas fa-comment-dots text-4xl animate-spin-slow-reverse"></i></div>
        <div class="snowflake animate-float" style="top: 45%; left: 85%;"><i class="fas fa-hashtag text-7xl animate-spin-slow opacity-10"></i></div>
    </div>
            ...
            <div class="flex justify-between items-center">
                ...
                <nav class="hidden md:flex items-center space-x-8" data-aos="fade-down" data-aos-duration="800" data-aos-delay="200">
                    ...
                    <div class="border-l-2 pl-4 flex space-x-2 text-sm font-bold text-gray-400">
                        <a href="smm.php" class="hover:text-gray-800 transition">EN</a>
                        <span>|</span>
                        <a href="smm_fr.php" class="text-primary">FR</a>
                    </div>
                </nav>
            </div>
        </div>
    ...
    <section class="py-24 md:py-32 relative overflow-hidden bg-dark z-10">
        <div class="absolute top-0 left-0 w-full h-full overflow-hidden opacity-10 pointer-events-none">
            <i class="fab fa-instagram text-primary text-6xl absolute top-20 left-[10%] animate-float" style="animation-delay: 0s;"></i>
            <i class="fab fa-tiktok text-white text-5xl absolute top-40 right-[15%] animate-float" style="animation-delay: 2s;"></i>
            <i class="fab fa-linkedin text-primary text-7xl absolute bottom-20 left-[20%] animate-float" style="animation-delay: 4s;"></i>
            <i class="fab fa-facebook text-white text-4xl absolute bottom-40 right-[10%] animate-float" style="animation-delay: 1s;"></i>
        </div>
        ...
        <div class="container mx-auto px-4 max-w-4xl text-center relative z-10 text-white">
            <h1 class="text-5xl md:text-7xl font-extrabold mb-6 leading-tight" data-aos="zoom-out-up" data-aos-duration="1000">
                Social Media <span class="text-primary inline-block animate-pulse">Marketing</span>
            </h1>
            <p class="text-gray-300 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto mb-10" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                Connectez, engagez et prospérez sur les plateformes sociales. Amplifiez la présence de votre marque avec nos services experts en marketing sur les réseaux sociaux.
            </p>
            <div data-aos="fade-up" data-aos-delay="500">
                <a href="#ads-platforms" class="inline-block border-2 border-primary text-primary font-bold py-3 px-8 rounded-full hover:bg-primary hover:text-white transition duration-300 hover:-translate-y-2 animate-bounce">
                    Découvrir nos Plateformes <i class="fas fa-arrow-down ml-2"></i>
                </a>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="flex flex-col lg:flex-row items-center gap-16">
                <div class="lg:w-1/2 relative group" data-aos="fade-right" data-aos-duration="1200">
                    ...
                    <img src="https://images.unsplash.com/photo-1611162617474-5b21e879e113?auto=format&fit=crop&w=800&q=80" alt="Engagement Réseaux Sociaux" class="relative rounded-[2rem] shadow-2xl w-full object-cover h-[500px] transform transition duration-700 group-hover:scale-[1.02]" loading="lazy">
                </div>
                
                <div class="lg:w-1/2" data-aos="fade-left" data-aos-duration="1200">
                    <h4 class="text-sm font-bold text-gray-800 mb-4 border-b-2 border-primary pb-2 inline-block uppercase tracking-wider">Passionné – Dévoué – Professionnel</h4>
                    <h2 class="text-4xl md:text-5xl font-extrabold mb-10 text-dark leading-tight">Propulsez le Succès de Votre Entreprise avec le <span class="text-primary">SMM</span></h2>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-5 group hover:translate-x-2 transition-transform duration-300 bg-white p-4 rounded-2xl shadow-sm border border-transparent hover:border-orange-100 hover:bg-orange-50" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div>
                                <h3 class="text-xl font-bold mb-2 text-dark">Magie des Campagnes</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">Lancez des campagnes publicitaires ultra-ciblées qui résonnent profondément avec votre audience idéale.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-5 group hover:translate-x-2 transition-transform duration-300 bg-white p-4 rounded-2xl shadow-sm border border-transparent hover:border-orange-100 hover:bg-orange-50" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div>
                                <h3 class="text-xl font-bold mb-2 text-dark">Maîtrise Analytique</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">Obtenez des insights précieux sur vos performances sociales pour prendre des décisions basées sur la data.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-5 group hover:translate-x-2 transition-transform duration-300 bg-white p-4 rounded-2xl shadow-sm border border-transparent hover:border-orange-100 hover:bg-orange-50" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div>
                                <h3 class="text-xl font-bold mb-2 text-dark">Rayonnement des Résultats</h3>
                                <p class="text-gray-600 text-sm leading-relaxed">Vivez l'éclat du succès numérique et observez une croissance tangible de votre communauté et de vos ventes.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="ads-platforms" class="py-24 bg-light fade-edges overflow-hidden relative z-10 border-y border-gray-200">
        <div class="container mx-auto px-4 text-center mb-16" data-aos="zoom-in">
            <h4 class="text-sm font-bold uppercase tracking-wider text-primary mb-2">Acquisition Multicanal</h4>
            <h2 class="text-4xl md:text-5xl font-extrabold text-dark">L'Expertise <span class="text-primary">Social Ads</span></h2>
            <p class="text-gray-600 mt-4 max-w-2xl mx-auto text-lg">Nous maîtrisons les régies publicitaires les plus puissantes du marché pour diffuser votre message là où se trouve votre audience.</p>
        </div>
        ...
        <div class="flex flex-col gap-8 w-full relative">
            ...
            <div class="flex items-center" data-aos="fade-left" data-aos-delay="100">
                <div class="marquee-container animate-scroll-left">
                    <div class="flex items-center">
                        <div class="social-card hover-tiktok"><i class="fab fa-tiktok text-3xl text-black"></i><span class="font-extrabold text-lg text-black uppercase tracking-wide">TikTok Ads</span></div>
                        <div class="social-card hover-meta"><i class="fab fa-facebook text-3xl text-blue-600"></i><span class="font-extrabold text-lg text-blue-600 uppercase tracking-wide">Facebook Ads</span></div>
                        <div class="social-card hover-snapchat"><i class="fab fa-snapchat-ghost text-3xl text-yellow-400" style="text-shadow: 0 0 1px black;"></i><span class="font-extrabold text-lg text-yellow-500 uppercase tracking-wide">Snapchat Ads</span></div>
                        <div class="social-card hover-linkedin"><i class="fab fa-linkedin text-3xl text-blue-700"></i><span class="font-extrabold text-lg text-blue-700 uppercase tracking-wide">LinkedIn Ads</span></div>
                        <div class="social-card hover-insta"><i class="fab fa-instagram text-3xl text-pink-600"></i><span class="font-extrabold text-lg text-pink-600 uppercase tracking-wide">Instagram Ads</span></div>
                    </div>
                    <div class="flex items-center">
                        <div class="social-card hover-tiktok"><i class="fab fa-tiktok text-3xl text-black"></i><span class="font-extrabold text-lg text-black uppercase tracking-wide">TikTok Ads</span></div>
                        <div class="social-card hover-meta"><i class="fab fa-facebook text-3xl text-blue-600"></i><span class="font-extrabold text-lg text-blue-600 uppercase tracking-wide">Facebook Ads</span></div>
            ...
            <div class="flex items-center" data-aos="fade-right" data-aos-delay="300">
                <div class="marquee-container animate-scroll-right">
                    <div class="flex items-center">
                        <div class="social-card hover-youtube"><i class="fab fa-youtube text-3xl text-red-600"></i><span class="font-extrabold text-lg text-red-600 uppercase tracking-wide">YouTube Ads</span></div>
                        <div class="social-card hover-x"><i class="fa-brands fa-x-twitter text-3xl text-black"></i><span class="font-extrabold text-lg text-black uppercase tracking-wide">X (Twitter) Ads</span></div>
                        <div class="social-card hover-pinterest"><i class="fab fa-pinterest text-3xl text-red-600"></i><span class="font-extrabold text-lg text-red-600 uppercase tracking-wide">Pinterest Ads</span></div>
                        <div class="social-card hover-meta"><i class="fab fa-facebook-messenger text-3xl text-blue-500"></i><span class="font-extrabold text-lg text-blue-500 uppercase tracking-wide">Messenger Ads</span></div>
                        <div class="social-card hover-tiktok"><i class="fas fa-bullseye text-3xl text-primary"></i><span class="font-extrabold text-lg text-primary uppercase tracking-wide">Retargeting</span></div>
                    </div>
                    <div class="flex items-center">
                        <div class="social-card hover-youtube"><i class="fab fa-youtube text-3xl text-red-600"></i><span class="font-extrabold text-lg text-red-600 uppercase tracking-wide">YouTube Ads</span></div>
                        <div class="social-card hover-x"><i class="fa-brands fa-x-twitter text-3xl text-black"></i><span class="font-extrabold text-lg text-black uppercase tracking-wide">X (Twitter) Ads</span></div>
    ...
    <section id="process" class="py-24 bg-peach relative z-10 overflow-hidden border-t border-gray-200">
        <div class="absolute right-0 top-10 text-primary opacity-5"><i class="fas fa-route text-[25rem] animate-spin-slow-reverse"></i></div>
        
        <div class="container mx-auto px-4 max-w-7xl relative z-10">
            <div class="text-center mb-20" data-aos="fade-down">
                <h2 class="text-4xl md:text-5xl font-extrabold text-dark leading-tight mb-4">Les Étapes Que<br><span class="text-primary">Nous Suivons</span></h2>
                <p class="text-gray-600 leading-relaxed max-w-2xl mx-auto">
                    Élevez la présence de votre marque avec notre service de Social Media Marketing. Nous créons des stratégies percutantes pour libérer tout le potentiel de votre entreprise et la faire briller.
                </p>
            </div>
            ...
            <div class="relative w-full max-w-5xl mx-auto">
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group">
                    ...
                    <div class="w-full pl-20 md:pl-0 md:w-5/12 md:pr-12" data-aos="fade-right" data-aos-delay="100">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-l-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Planification Stratégique</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Pour tracer la voie du succès, nous analysons votre entreprise, votre audience cible et vos concurrents afin de concevoir une stratégie sur mesure.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group md:flex-row-reverse">
                    ...
                    <div class="w-full pl-20 md:pl-12 md:w-5/12" data-aos="fade-left" data-aos-delay="200">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-r-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Création de Contenu</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Captivez votre audience ! Notre équipe créative développe des visuels époustouflants, des vidéos engageantes et des textes percutants.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group">
                    ...
                    <div class="w-full pl-20 md:pl-0 md:w-5/12 md:pr-12" data-aos="fade-right" data-aos-delay="300">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-l-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Gestion de Plateformes</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Nous gérons vos comptes sur diverses plateformes (Instagram, Facebook, Twitter, LinkedIn). Des publications régulières et une interaction constante renforcent la fidélité.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group md:flex-row-reverse">
                    ...
                    <div class="w-full pl-20 md:pl-12 md:w-5/12" data-aos="fade-left" data-aos-delay="400">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-r-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Campagnes Publicitaires</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Boostez votre portée et vos taux de conversion avec des publicités payantes ciblées. Nous optimisons les performances pour garantir un ROI maximal.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full mb-12 md:mb-16 group">
                    ...
                    <div class="w-full pl-20 md:pl-0 md:w-5/12 md:pr-12" data-aos="fade-right" data-aos-delay="500">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-l-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Analyses et Rapports</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Nous croyons aux décisions fondées sur les données. Recevez des analyses détaillées sur les performances de vos campagnes pour affiner nos stratégies.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative flex justify-start md:justify-end items-center w-full group md:flex-row-reverse" id="deployment-node">
                    ...
                    <div class="w-full pl-20 md:pl-12 md:w-5/12" data-aos="fade-left" data-aos-delay="600">
                        <div class="node-card bg-white p-8 rounded-2xl shadow-md border-r-4 border-transparent">
                            <h3 class="text-2xl font-bold mb-3 text-dark group-hover:text-primary transition-colors">Consultations Mensuelles</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Restez informé avec nos consultations. Nous discutons des performances, des stratégies à venir et des ajustements nécessaires pour garder une longueur d'avance.</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-0 mb-20 relative z-20">
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="bg-gradient-to-r from-gray-900 to-primary rounded-[3rem] flex flex-col md:flex-row items-center overflow-hidden shadow-2xl relative" data-aos="zoom-in" data-aos-duration="1000">
                ...
                <div class="absolute top-10 right-20 text-white opacity-20 animate-float"><i class="fas fa-bullhorn text-9xl"></i></div>
                
                <div class="md:w-1/2 h-full z-10 overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1556761175-5973dc0f32b7?auto=format&fit=crop&w=800&q=80" alt="Consultation Marketing" class="w-full h-full object-cover min-h-[400px] transition-transform duration-1000 hover:scale-110 opacity-90 mix-blend-overlay">
                </div>
                <div class="md:w-1/2 p-10 md:p-16 text-white relative z-20">
                    <h2 class="text-4xl md:text-5xl font-extrabold mb-6 leading-tight">Nos Services sont toujours en phase avec votre stratégie</h2>
                    <p class="text-gray-200 mb-10 text-lg leading-relaxed">
                        Chez BOUDALIA Agency, nous offrons une gamme de solutions innovantes et de pointe pour vos besoins commerciaux. Du développement web au SMM pointu, nous délivrons des résultats de haute qualité.
                    </p>
                    <a href="formulaire.php" class="inline-block bg-white text-primary font-bold py-4 px-10 rounded-full hover:bg-dark hover:text-white transition duration-500 shadow-lg transform hover:-translate-y-2 hover:shadow-2xl animate-pulse-glow">
                        Booster mon Social Media <i class="fas fa-arrow-right ml-2"></i>
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-col md:flex-row justify-between gap-10 mb-16">
                <div class="md:w-5/12">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed pr-4">
                        BOUDALIA Agency est votre destination privilégiée pour tous vos besoins digitaux. De la création de sites web visuellement époustouflants à la mise en œuvre de stratégies sur les réseaux sociaux redoutables.
                    </p>
                </div>
                <div class="md:w-3/12 flex md:justify-center">
                    <ul class="space-y-3 font-bold text-gray-800 text-sm">
                        ...
                        <li><a href="smm_fr.php" class="text-primary transition hover:translate-x-2 inline-block transform">Social Media Marketing</a></li>
                    </ul>
                </div>
    ...
    <script>
        ...
        function triggerFireworks() {
            ...
            (function frame() {
                confetti({ particleCount: 5, angle: 60, spread: 55, origin: { x: 0 }, colors: ['#f97316', '#ea580c', '#ffffff', '#1e293b'] });
                confetti({ particleCount: 5, angle: 120, spread: 55, origin: { x: 1 }, colors: ['#f97316', '#ea580c', '#ffffff', '#1e293b'] });
        ...
        if(deploymentNode) deploymentObserver.observe(deploymentNode);
    </script>
</body>
</html>